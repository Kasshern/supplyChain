...
contract ItemManager {
    ...
    function triggerPayment(uint _index) public payable {
        ...
        require(items[_index]._step == SupplyChainSteps.Created, "Item is beyond the Create stage in the supply chain");
        items[_index]._step = SupplyChainSteps.Paid;
        emit SupplyChainStep(_index, uint(items[index]._step));
    }

    fuction triggerDelivery(uint _index) public {
